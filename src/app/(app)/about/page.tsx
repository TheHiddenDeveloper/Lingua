  ...
  return (
    <div className="container mx-auto max-w-4xl p-4 md:p-6 space-y-8">
      ...
      <div className="space-y-8">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center text-2xl"><Heart className="w-7 h-7 mr-3 text-primary" />Our Mission</CardTitle>
          </CardHeader>
          <CardContent className="text-muted-foreground space-y-3 text-base text-justify">
            <p>Polyglot is dedicated to bridging communication gaps by providing accessible and reliable translation tools.</p>
            <p>Our goal is to empower individuals, promote cultural exchange, and make information more accessible to all, regardless of linguistic background.</p>
          </CardContent>
        </Card>

        <Card>
          <CardHeader>
            <CardTitle className="flex items-center text-2xl"><BookOpen className="w-7 h-7 mr-3 text-primary" />Project Story</CardTitle>
          </CardHeader>
          <CardContent className="text-muted-foreground space-y-3 text-base text-justify">
            <p>This application was born from a passion for technology and a deep appreciation for the world's rich linguistic diversity.</p>
            <p>We recognized the need for tools that make inter-language communication easier. This app represents our commitment to leveraging technology for positive social impact.</p>
          </CardContent>
        </Card>
        
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center text-2xl"><Users className="w-7 h-7 mr-3 text-primary" />The Team</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center text-2xl"><Award className="w-7 h-7 mr-3 text-primary" />Acknowledgements</CardTitle>
          </CardHeader>
        ...
        <Card>
           <CardHeader>
            <CardTitle className="flex items-center text-2xl"><Code className="w-7 h-7 mr-3 text-primary" />Technology & Credits</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center text-2xl"><GitBranch className="w-7 h-7 mr-3 text-primary" />Version Information</CardTitle>
          </CardHeader>
        ...
        <Card className="text-center">
           <CardHeader>
            <CardTitle className="flex items-center justify-center text-2xl"><Mail className="w-7 h-7 mr-3 text-primary" />Contact & Feedback</CardTitle>
          </CardHeader>
          <CardContent>
